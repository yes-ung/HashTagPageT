  ...
  <body>
    <div class="page">
      <header class="main-header">
        ...
        <c:if test="${sessionScope.usersVO != null}">
	     <a href="<c:url value='/logout.do'/>" class="a-rounded login pl2"> 로그아웃</a>
        ...
        <nav class="nav-bar mb1">
          ...
          <div class="menu-nav">
            <ul class="main-menu">
              ...
              <li>
              <c:url var="communityUrl" value="/hashtagpage/community.do" />
...
function initHeaderInteractions(status) {
	  ...
	  const menuData = {
			  webtoon: [
			    ...
			    { name: "스포츠", url: "/hashtagpage/webtoon.do?genre=스포츠" },
			    { name: "공포/추리", url: "/hashtagpage/webtoon.do?genre=공포/추리" },
			    { name: "드라마", url: "/hashtagpage/webtoon.do?genre=드라마" },
			  ...
			  webnovel: [
			    ...
			    { name: "로맨스판타지", url: "/hashtagpage/webnovel.do?genre=로맨스판타지" },
			    { name: "무협", url: "/hashtagpage/webnovel.do?genre=무협" },
			    { name: "공포/추리", url: "/hashtagpage/webnovel.do?genre=공포,추리" },
			    { name: "BL/GL", url: "/hashtagpage/webnovel.do?genre=판타지,SF" }
			  ],
			  community: [
			    { name: "자유게시판", url: "/hashtagpage/community/list.do?genre=자유게시판" },
			    { name: "뜨거운논쟁", url: "/hashtagpage/community/list.do?genre=뜨거운논쟁" },
			    { name: "작품추천", url: "/hashtagpage/community/list.do?genre=작품추천" }
			  ]
			};
