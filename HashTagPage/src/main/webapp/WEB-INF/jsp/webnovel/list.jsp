      ...
      <main class="webnovel-series-detail mt4">
        <div class="series-flex-row">
          ...
          <div class="webnovel-series-info w75">
            ...
            <p class="mb1">✍ <a href="<c:url value='/author.do'><c:param name='authorId' value="${series.authorId}" /></c:url>" >${series.authorId}</a> | 🏷️ ${series.typeId}</p>
            <p class="mb1">📖 총 ${fn:length(episode)}화 | 📚 <a href="<c:url value='/publisher.do'><c:param name='publisherId' value="${series.publisherId}" /></c:url>" >${series.publisherId}</a></p>
            <p class="mb1">⭐ 평점 4.9 (13,753명)</p>
            <div class="button-group">
              <a href="<c:url value='/hashtagpage/webnovel/detail.do'><c:param name='seriesId' value="${series.seriesId}" />
              <c:param name='episodeId' value="1" /></c:url>" class="a-rounded-al mr2">첫 화 보기</a>
