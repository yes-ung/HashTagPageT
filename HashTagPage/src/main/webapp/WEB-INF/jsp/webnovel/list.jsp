      ...
      <main class="webnovel-series-detail mt4 mb4">
        <div class="series-flex-row">
          ...
          <div class="webnovel-series-info w75">
            ...
            <p class="mb1">✍ ${books.authorId} | 🏷️ ${books.typeId} | 📚 총 31화</p>
          ...
          <ul class="episodeContainer">
            ...
            <li class="episode-item mb1">
              <a href="/episode/view/1" class="episode-link">
                <div class="thumb">
                  <img src="/img/episode2.jpg" alt="1화 썸네일" />
                </div>
                <div class="episode-number">1화</div>
                <div class="episode-title">할일이 없다</div>
              </a>
            ...
            <li class="episode-item mb1">
              <a href="/episode/view/1" class="episode-link">
                <div class="thumb">
                  <img src="/img/episode2.jpg" alt="2화 썸네일" />
                </div>
                <div class="episode-number">2화</div>
                <div class="episode-title">Lofi 감성</div>
              </a>
              <div class="sub-info">무료</div>
            </li>
            ...
            <li class="episode-item mb1">
              <a href="/episode/view/1" class="episode-link">
                <div class="thumb">
                  <img src="/img/episode2.jpg" alt="3화 썸네일" />
                </div>
                <div class="episode-number">3화</div>
                <div class="episode-title">그만하자 제발</div>
              </a>
              <div class="sub-info">무료</div>
            </li>
