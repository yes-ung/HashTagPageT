...
<body>
                ...
                <div class="mycase-content pl1">
                    <div class="mycase-title">
                        ...
                        <div class="mycase-subtitle">
                            <h4><a href="#">최근 본 작품</a>&nbsp;&nbsp;&nbsp;
                            <a href="<c:url value='/hashtagpage/mypageCaseZzim.do' />" >찜 목록</a></h4>                           
                            <p></p>
    ...
    <!-- 헤더 햄버거 -->
        <script type="module">
      import { setupMainHeader, setupFooter } from "./layout.js";

      setupMainHeader("user"); // or "guest"
      setupFooter(); // ID가 footer인 div에 footer.html 삽입
    </script>
</body>
