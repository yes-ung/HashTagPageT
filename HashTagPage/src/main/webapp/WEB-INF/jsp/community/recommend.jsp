    ...
    <main>
      ...
      <div class="community-container">
            ...
            <div class="recommended-subjectbox">
              <div class="recommended-subject-body">
                    ...
                    <div class="written-btn">
                      <a href="<c:url value='/hashtagpage/community/recommendSubmit.do' />" >
       ...
       <c:forEach var="data" items="${boardPostList}">
                <a href="<c:url value='/hashtagpage/community/recommendDetail.do'><c:param name='postId' value="${data.postId}" /></c:url>" >
                   <li class="post-row">
